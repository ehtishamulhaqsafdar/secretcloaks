...
<!-- Mirrored from demo.themefisher.com/themefisher/aviato/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Jan 2020 10:31:59 GMT -->
<head>
    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          ...
          <form class="text-left clearfix" action="manageproduct.php" >
