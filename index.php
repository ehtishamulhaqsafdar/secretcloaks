...
<!-- Mirrored from demo.themefisher.com/themefisher/aviato/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Jan 2020 10:29:23 GMT -->
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <meta name="description" content="Secret Cloaks">
  
  <meta name="author" content="prowork.com">

  <title>Secret Cloaks</title>
			...
			if($result->num_rows > 0) {
				...
				<div class='product-item'>
					<div class='product-thumb'>
						...
						<img class='img-responsive' src='".$row['img']."' alt='product-img' />
					...
					<div class='product-content'>
						...
						<p class='price'>price range ".$row['price']."</p>
					</div>
				</div>
			</div>";
				}
...
<!-- Mirrored from demo.themefisher.com/themefisher/aviato/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Jan 2020 10:30:22 GMT -->
</html>
